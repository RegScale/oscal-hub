...
public enum AuditEventType {
    ...
    /**
     * Security policy changed (MFA requirements, password policies, etc.)
     * <p>Risk Level: HIGH (security-wide impact)</p>
     * <p>Retention: LONG (compliance)</p>
     */
    CONFIG_SECURITY_POLICY_CHANGE("Configuration", "Security policy changed", "HIGH"),
     ...
     * <p>Risk Level: CRITICAL (active threat)</p>
     * <p>Retention: LONG (security forensics, compliance)</p>
     * <p>SIEM: Immediate notification required</p>
     */
    SECURITY_MALWARE_DETECTED("Security", "Malware detected in uploaded file", "HIGH"),
    ...
    /**
     * MFA setup initiated by user
     * <p>Risk Level: LOW</p>
     * <p>Retention: LONG (security monitoring)</p>
     */
    MFA_SETUP_INITIATED("Security", "MFA setup initiated", "LOW"),

    /**
     * MFA setup completed successfully
     * <p>Risk Level: MEDIUM (security configuration)</p>
     * <p>Retention: LONG (compliance)</p>
     */
    MFA_SETUP_COMPLETED("Security", "MFA setup completed", "MEDIUM"),
     ...
     * <p>Retention: MEDIUM</p>
     */
    MFA_VERIFICATION_SUCCESS("Security", "MFA verification successful", "LOW"),
     ...
     * <p>Retention: LONG (security monitoring)</p>
     */
    MFA_VERIFICATION_FAILURE("Security", "MFA verification failed", "MEDIUM"),

    /**
     * Backup code used for MFA verification
     * <p>Risk Level: MEDIUM (emergency access)</p>
     * <p>Retention: LONG (security monitoring)</p>
     */
    MFA_BACKUP_CODE_USED("Security", "MFA backup code used", "MEDIUM"),

    /**
     * Backup codes regenerated by user
     * <p>Risk Level: MEDIUM (security configuration)</p>
     * <p>Retention: LONG (security monitoring)</p>
     */
    MFA_BACKUP_CODES_REGENERATED("Security", "MFA backup codes regenerated", "MEDIUM"),

    /**
     * MFA disabled for user account
     * <p>Risk Level: HIGH (security downgrade)</p>
     * <p>Retention: LONG (compliance)</p>
     */
    MFA_DISABLED("Security", "MFA disabled", "HIGH"),
