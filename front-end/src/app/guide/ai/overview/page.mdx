...
Three wizards are available today:
...
The **Catalog** and **Component-definition** wizards produce *drafts* — after generation, the draft opens in the corresponding builder so you can review, edit, and save. AI-generated documents are never saved to your library without an explicit save action.
...
Additional document wizards (Profile, SSP, POA&M) are planned and will appear in the picker as they become available.
